...
// Guardar artículo
router.post('/articles/save', jwtMiddleware, celebrate({
...
// Crear artículo
router.post('/articles', jwtMiddleware, celebrate({
  body: Joi.object().keys({
    keyWord: Joi.string().required(),
    title: Joi.string().required(),
    text: Joi.string().required(),
...
// Eliminar artículo
router.delete('/articles/articleId', jwtMiddleware, articlesController.deleteArticleById);
